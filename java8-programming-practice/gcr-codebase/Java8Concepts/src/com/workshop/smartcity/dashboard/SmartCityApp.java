...
public class SmartCityApp {
    public static void main(String[] args) {
        ...
        List<Passenger> passengers = Arrays.asList(
                new Passenger("Rahul", "P001", 45.0, "B101", true),
                new Passenger("Aman", "P002", 28.0, "M201", false),
                new Passenger("Ankit", "P003", 180.0, "T301", true),
                new Passenger("Anirudh", "P004", 42.0, "B101", true),
                new Passenger("Vivek", "P005", 35.0, "B101", false)
        );
