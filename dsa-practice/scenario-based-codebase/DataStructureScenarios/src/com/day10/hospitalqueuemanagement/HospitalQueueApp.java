...
public class HospitalQueueApp {
	public static void main(String[] args) {
		...
		queue.registerPatient(
				new Patient("P20260123-001", "Arjun Mehta", "2026-01-23 08:15", "General Medicine", "Fever & Cough"));
		queue.registerPatient(
				new Patient("P20260123-002", "Neha Kapoor", "2026-01-23 08:40", "Orthopedics", "Knee Pain"));
		queue.registerPatient(
				new Patient("P20260123-003", "Karan Malhotra", "2026-01-23 07:55", "Pediatrics", "Child Fever"));
		queue.registerPatient(
				new Patient("P20260123-004", "Ananya Iyer", "2026-01-23 09:10", "ENT", "Ear Infection"));
		queue.registerPatient(
				new Patient("P20260123-005", "Rohit Bansal", "2026-01-23 08:50", "General Medicine", "Stomach Ache"));

		System.out.println("Current Waiting Queue (by arrival time):");
		queue.displayQueue();

		// Scenario 2: Discharge / remove patient
		System.out.println("\nPatient P20260123-003 (Karan Malhotra) discharged / seen");
